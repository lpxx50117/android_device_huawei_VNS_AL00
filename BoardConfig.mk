...
DEVICE_PATH := device/huawei/VNS_AL00
...
#TARGET_KERNEL_CONFIG := vns_defconfig
...
# Assert
TARGET_OTA_ASSERT_DEVICE := VNS-AL00, VNS_AL00

# Partitions
#BOARD_RECOVERYIMAGE_PARTITION_SIZE := 47808512 # This is the maximum known partition size, but it can be higher, so we just omit it
